        ...
        <section className='section-1'>
          ...
          <article className='article-1'>
            <div className='card'>
              ...
              <img className='img-handler' src='https://assets.nintendo.com/image/upload/c_fill,w_1200/q_auto:best/f_auto/dpr_2.0/ncom/en_US/dlc/switch-dlc/pokemon-violet-dlc/rom-bundle/pokemon-scarlet-and-pokemon-violet-double-pack/image' />
              </div>
            </div>
          </ article>
          <article>
